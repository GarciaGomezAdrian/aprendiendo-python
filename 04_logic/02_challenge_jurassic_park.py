...
# Para ver si un número es par siempre usamos el módulo %
# Que nos da el resto de la división: eggs % 2 == 0

def count_carnivore_dinosaur_eggs(egg_list) -> int:
  """
  Esta función recibe una lista de números enteros que representan la cantidad de huevos que han puesto
  diferentes dinoraurios en el parque jurásico y los de número par son de carnívoros. Devuelve un número
