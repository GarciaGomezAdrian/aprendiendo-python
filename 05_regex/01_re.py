...
""" Las expresiones regulares son una secuencia de caracteres que forman un patrón de busqueda.
    Se utilizan para la búsqueda de cadena de texto, validación de datos, etc. """
...
cuantas_midu = re.findall(pattern, text)
donde_midu = re.finditer(pattern, text)

for donde in donde_midu:
  print(donde.group(), donde.start(), donde.end())
print(f"Se ha encontrado la palabra 'midu' un total de {len(cuantas_midu)} veces")
